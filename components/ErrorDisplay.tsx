...
const ErrorDisplay: React.FC<ErrorDisplayProps> = ({ message, rawResponse }) => {
  return (
    <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-500/30 text-red-700 dark:text-red-300 px-4 py-3 rounded-xl space-y-3 animate-fade-in" role="alert">
